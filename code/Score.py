...
from code.Const import YELLOW, SCORE_POS, MENU_OPTION, WHITE
...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int]):
        pygame.mixer_music.load('./assets/ScoreSong.mp3')
        ...
        while True:
            ...
            self.score_text(48,'YOU WON!', YELLOW, SCORE_POS['Title'])
            ...
            self.score_text(20, text, WHITE, SCORE_POS['TypeName'])
    ...
    def show(self):
        ...
        pygame.mixer_music.play(-1)
        self.window.blit(source=self.surf, dest=self.rect)
        self.score_text(60, 'TOP 5 SCORES', YELLOW, SCORE_POS['Title'])
        self.score_text(20, 'NAME      SCORE     DATE', YELLOW, SCORE_POS['Label'])
        db_proxy = DBProxy('DBScore')
        ...
        for player_score in list_score:
            ...
            self.score_text(18, f'         {name}        {score :05d}       {date}',
                            YELLOW, SCORE_POS[list_score.index(player_score)])
